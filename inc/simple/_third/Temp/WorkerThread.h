...
//	Usage:
//
//	Start a WorkerThread by calling 'Start'.
//	Stop a WorkerThread by calling 'Stop'.
//	Pause/Unpause a WorkerThread by calling 'Pause'.
...
public:
	...
	WorkerThread() : m_status(Stopped), m_dwThreadID(0), m_hThread(NULL) {}
...
protected:
	...
	//	is properly called.
	static unsigned int CALLBACK	ThreadProcess(void* lpParameter);
