#ifndef DISPATCHPTR_H_WIN_66BC65DB_AFF6_43C8_8654_D1A2801635E2
#define DISPATCHPTR_H_WIN_66BC65DB_AFF6_43C8_8654_D1A2801635E2
...
protected:
    ...
    void InvokeHelper(LPCSTR dispatchItem,
        ...
        int cch = lstrlenA(dispatchItem) + 1;
